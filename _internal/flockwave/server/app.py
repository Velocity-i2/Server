#!/usr/bin/env python3
"""Application object for the Aerostem Server."""
...
class SkybrushServer(DaemonApp):
    """Main application object for the Aerostem Server."""
    ...
    def _create_components(self) -> None:
        ...
        self.dirs = AppDirs("Aerostem Server", "CollMot Robotics")
