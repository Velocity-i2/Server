...
For instance, a Aerostem Server may participate in a MAVLink network with two
...
MAVLink networks in the Aerostem Server allows us to manage multiple independent
...
class MAVLinkNetwork:
    ...
    def __init__(
        ...
        *,
        ...
        identifiers must be unique in the Aerostem Server.

        Parameters:
            id: the network ID
            system_id: the MAVLink system ID of the Aerostem Server within the
                network
