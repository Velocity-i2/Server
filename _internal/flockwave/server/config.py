"""Default configuration for the Aerostem Server.
...
ntrip_ip = os.environ.get("NTRIP_IP", "192.168.0.106")
ntrip_url = f"ntrip://locosys:locosys@{ntrip_ip}:8888/locosys"
# print(f"📡 Final RTK URL: ntrip://x:x@{ntrip_ip}:8888/x")
