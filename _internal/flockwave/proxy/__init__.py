...
then parsed and forwarded to a _local_ Aerostem Server; responses are relayed
back.

This can be used in field tests where the Aerostem Server on the field does not
...
- The Aerostem Server and the Skybrush proxy is started up on the field computer.
  The proxy is instructed to connect to the remote server on port 5000 and to
  the local Aerostem Server, also on port 5000.
"""
